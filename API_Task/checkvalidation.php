...
<body>
    <div class="container mt-5">
            ...
            <form action="" method="get">
                ...
                <tr>
                    <div class="col-6">
                        ...
                        <input type="text" name="username" id="username" onkeyup="check(this,'username')" class="form-control">
                ...
                <tr>
                    <div class="col-6">
                        ...
                        <input type="email" name="email" id="email" onkeyup="check(this,'email')" class="form-control">
                ...
                <tr>
                    <div class="col-6">
                        ...
                        <input type="text" name="phone" id="phone" onkeyup="check(this,'phone')" class="form-control">
        ...
        <script>
            async function check(e, field) {
                // console.log(e, field);
                // console.log(e.value);
                if (e.value != "") {
                    let userdatabyfield = await fetch(`http://localhost/Laravel/API_Task/Backend/checkemail?email=${e.value}`)
