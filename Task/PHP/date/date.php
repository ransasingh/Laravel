...
echo "<br><br><br>timestamp : $now <br>";
echo "your_date : $your_date <br>";
$datediff = $now - $your_date;
echo "<br>Diff days : $datediff <br>";
echo round($datediff / (60 * 60 * 24));



$originalDate = "1999-03-28";
echo "<br><br><br>".$newDate = date("d-m-Y l", strtotime($originalDate));
?>
