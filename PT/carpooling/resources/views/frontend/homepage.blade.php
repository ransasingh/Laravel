...
<section class="about_section layout_padding">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="img-box">
                    <img src="{{('assests/images/about-img.png')}}" alt="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="detail-box">
        ...
        <div class="why_container">
            <div class="row">
                <div class="col-md-4">
                    <div class="box b1">
                        <div class="img-box">
                            <img src="{{('assests/images/w1.png')}}" alt="" class="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Fast & Easy Booking
                ...
                <div class="col-md-4">
                    <div class="box b2">
                        <div class="img-box">
                            <img src="{{('assests/images/w2.png')}}" alt="" class="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Driving safety
                ...
                <div class="col-md-4">
                    <div class="box b3">
                        <div class="img-box">
                            <img src="{{('assests/images/w3.png')}}" alt="" class="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Full Satisfaction
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="detail-box">
                    ...
                    <div class="btn-box">
                        <a href="">
                            <img src="{{('assests/images/app_store.png')}}" alt="">
                        </a>
                        <a href="">
                            <img src="{{('assests/images/google_play.png')}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="img-box">
                    <img src="{{('assests/images/app-img.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box">
                    <div class="img-box">
                        <img src="{{('assests/images/b1.jpg')}}" alt="">
                    </div>
                    <div class="detail-box">
                        <h6 class="blog_date">
                            29 July 2020
