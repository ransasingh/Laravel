...
echo md5("admin%asdfass")."<br>";  // use for the encription and its one way encription we cant decript it
...
echo $str = " The    tops Tech Something  data   ";
echo $str1 = "The    tops tech   data";
...
echo "For generating hyperlink like ".$strhtmlent;
